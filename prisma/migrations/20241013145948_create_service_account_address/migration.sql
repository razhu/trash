...
CREATE TABLE "user_service_accounts" (
    ...
    CONSTRAINT "user_service_accounts_pkey" PRIMARY KEY ("user_id","service_account_id")
);
...
-- AddForeignKey
ALTER TABLE "service_accounts" ADD CONSTRAINT "service_accounts_address_id_fkey" FOREIGN KEY ("address_id") REFERENCES "addresses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_service_accounts" ADD CONSTRAINT "user_service_accounts_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_service_accounts" ADD CONSTRAINT "user_service_accounts_service_account_id_fkey" FOREIGN KEY ("service_account_id") REFERENCES "service_accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
